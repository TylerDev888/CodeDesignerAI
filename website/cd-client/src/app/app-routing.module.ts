...
import { CodeEditor }               from './pages/playstation2/code-editor/code-editor';
import { Disassembler } from './pages/playstation2/disassembler/disassembler';
...
const routes: Routes = [
  ...
  // Code Designer
  {path: 'playstation2/code-editor', component: CodeEditor, data: { title: 'Code Editor' }},
  {path: 'playstation2/disassembler', component: Disassembler, data: { title: 'Disassembler' }},
